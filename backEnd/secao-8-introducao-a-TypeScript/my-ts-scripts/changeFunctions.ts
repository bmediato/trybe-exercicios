...
// function 4 - Essa função é responsável por receber um objeto e formar uma frase utilizando as chaves do mesmo.
...
// function 5 - Essa é uma função que verifica se a idade passada é maior ou menor de 18 anos.
